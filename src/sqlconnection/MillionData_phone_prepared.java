...
public class MillionData_phone_prepared {
	...
	public static void main(String[] args) {
		MillionData_phone_prepared tt = new MillionData_phone_prepared();
	...
	private void insertContactwithStatement(Connection con) {
		...
		try {
			...
			for (int i = 1; i <= totcnt; i++) {
				...
				String number = String.format("010-%04d-%04d", rd.nextInt(0000, 9999), rd.nextInt(0000, 9999));
